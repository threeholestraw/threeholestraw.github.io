...
export const Layout = () => {
  ...
  return (
    <div ref={ref} className="h-dvh w-full overflow-auto flex flex-col font-sans">
      <div className="min-h-[300vh] bg-linear-to-b from-[rgba(255,100,255,0.1)] to-[rgba(100,255,255,0.1)]">
        <Nav scrollY={scrollY} />
